...
{	
	 ...
	 $dbInfo = $_SESSION['dbInfo'];
        ...
        if ($conn) {
                if (!($this->systemValidator->isMySqlCompatible($dbInfo['dbHostName'], $dbInfo['dbUserName'], $dbInfo['dbPassword'], $dbInfo['dbHostPortModifier'], $dbInfo['dbHostPort']))){
                    $_SESSION['dbError'] = $this->systemValidator->getMysqlErrorMessage($dbInfo['dbHostName'], $dbInfo['dbUserName'], $dbInfo['dbPassword'], $dbInfo['dbHostPortModifier'], $dbInfo['dbHostPort']);
		}
